...
const NdsoCreate = () =>{
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://localhost:5000/ndsocreate_drug', values)
      .then((res) => {
        navigate('/ViewDrugs'); // Navigate to the View page after submission
      })
      .catch((err) => {
    ...
    <div className="d-flex vh-100 bg-primary justify-content-center align-items-center">
      <div className="form-container bg-white p-4 rounded shadow">
        <form onSubmit={handleSubmit}>
          <h2 className="mb-4">Add Drug Stock</h2>
